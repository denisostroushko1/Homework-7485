...
as strong within the bootsrap replications. 

@fig-ates-bw shows that IPW2 method of estimation of causal effect produces an estimate with the lowest variance. 
Regression Adjustment and Propensity Score Stratification methods produce very similar estimates. 
